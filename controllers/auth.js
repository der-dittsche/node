...
const transporter = nodemailer.createTransport(
  sendgridTransport({
    auth: {
      api_key:
        "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",
    },
  })
);
...
exports.postLogin = (req, res, next) => {
  ...
  if (!errors.isEmpty()) {
    return res.status(422).render("auth/login", {
      ...
      oldInput: { email: email, passowrd: password },
      ...
      .then((result) => {
        ...
        transporter.sendMail({
          ...
          html: `
              ...
              <p>Click this <a href="http://localhost:3000/reset/${token}">link</a> to reset your password</p><hr>
              <p>This link expired in 1h</p>`,
        });
      })
      .catch((err) => {
        console.log(err);
